...
import com.betteruniverse.mementolauncher.ui.components.DotIcon
import com.betteruniverse.mementolauncher.ui.components.DotIconType
...
import com.betteruniverse.mementolauncher.data.DotStyle
...
fun SettingsScreen(
    ...
    onDotStyleChange: (com.betteruniverse.mementolauncher.data.DotStyle) -> Unit,
    onAutoOpenKeyboardChange: (Boolean) -> Unit,
    onBackgroundStyleChange: (com.betteruniverse.mementolauncher.data.BackgroundStyle) -> Unit,
    onFontSizeChange: (com.betteruniverse.mementolauncher.data.FontSize) -> Unit
) {
            ...
            SettingsSection(title = "UI FONT SCALE", onBg) {
                SettingsCard {
                    Row(
                        ...
                        com.betteruniverse.mementolauncher.data.FontSize.entries.forEach { size ->
                            SegmentedControlButton(
            ...
            SettingsSection(title = "LAUNCHER BACKGROUND", onBg) {
                SettingsCard {
                    Row(
                        ...
                        com.betteruniverse.mementolauncher.data.BackgroundStyle.entries.forEach { style ->
                            SegmentedControlButton(
